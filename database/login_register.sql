...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2024 at 11:59 AM
...
CREATE TABLE `order_data` (
  ...
  `OrdName` varchar(256) NOT NULL,
  `OrdPhone` bigint(20) NOT NULL,
  `OrdAddress` varchar(256) NOT NULL,
  `OrdEmail` varchar(256) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 'Temp', 'temp@gmail.com', '$2y$10$qz5wSqXnVpeDgfc/Blg/L.DQ0FYNh6jM0f0YGiYZXRCe0GPoO1nmy');
